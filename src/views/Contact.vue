  ...
  <div>
    ...
    <ul>
        ...
        <li>
            ...
            <a href="mailto:fredpinheiro98@gmail.com" target="_blank">my@email.com</a>
        </li>
        <li>
            <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
            <a href="https://www.linkedin.com/in/frederico-pinheiro-7a9481159/" target="_blank">linkedin.com/me</a>
        </li>
        <li>
            <i class="fa fa-github fa-lg fa-fw"></i>
            <a href="https://github.com/fafpinheiro" target="_blank">github.com/me</a>
        </li>
        <!--<li>
