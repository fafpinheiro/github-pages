...
title: Projects
---
![Jinx from Arcane, a League of Legends Series, wearing soldering googles](assets/images/Ella-Purnell-Jinx-Arcane-League-of-Legends.webp)
# Project Index
- [Project Index](#project-index)
  - [Computer Science and Engineering (CSE)](#computer-science-and-engineering-cse)
    - [Artificial Intelligence (AI) Research](#artificial-intelligence-ai-research)
      - [Contrastive Learning Transformer (CLT) for Label Efficient Semantic Segmentation](#contrastive-learning-transformer-clt-for-label-efficient-semantic-segmentation)
      - [Multimodal Graph Neural Network (MGNN) for Automatic Generation of Coherent Image Descriptions](#multimodal-graph-neural-network-mgnn-for-automatic-generation-of-coherent-image-descriptions)
      - [CSE Master of Science (MSc) Dissertation](#cse-master-of-science-msc-dissertation)
      - [WSmart Route+](#wsmart-route)
    ...
    - [Game Development](#game-development)
      - [Project Emerald](#project-emerald)
      - [Project Fishes](#project-fishes)
  - [Bibliography](#bibliography)
    - [AI Research Literature](#ai-research-literature)
      - [CLT for Label Efficient Semantic Segmentation](#clt-for-label-efficient-semantic-segmentation)
      - [MGNN for Automatic Generation of Coherent Image Descriptions](#mgnn-for-automatic-generation-of-coherent-image-descriptions)
      - [CSE MSc Dissertation References](#cse-msc-dissertation-references)
      - [WSmart Route+ References](#wsmart-route-references)
...
- [WSmart Route Workshop Poster](assets/images/workshop_posters/workshop-poster.png)
...
- Bank, D., Koenigstein, N., & Giryes, R. (2021). [Autoencoders](assets/docs/literature/papers/autoencoders.pdf). arXiv [Cs.LG]. Retrieved from http://arxiv.org/abs/2003.05991

- Poklukar, P., Vasco, M., Yin, H., Melo, F. S., Paiva, A., & Kragic, D. (2022). [Geometric Multimodal Contrastive Representation Learning](assets/docs/literature/papers/geometric_multimodal_cl.pdf). arXiv [Cs.LG]. Retrieved from http://arxiv.org/abs/2202.03390

- Fernando, B., Bilen, H., Gavves, E., & Gould, S. (2017). [Self-Supervised Video Representation Learning With Odd-One-Out Networks](assets/docs/literature/papers/ssl_video_ooo_nets.pdf). arXiv [Cs.CV]. Retrieved from http://arxiv.org/abs/1611.06646

- Wu, M., & Goodman, N. (2018). [Multimodal Generative Models for Scalable Weakly-Supervised Learning](assets/docs/literature/papers/multimodal_gen_models_scalable_wsl.pdf). arXiv [Cs.LG]. Retrieved from http://arxiv.org/abs/1802.05335

#### WSmart Route+ References
- François-Lavet, V., Henderson, P., Islam, R., Bellemare, M. G., & Pineau, J. (2018). [An Introduction to Deep Reinforcement Learning](assets/docs/literature/papers/intro_drl.pdf). Foundations and Trends® in Machine Learning, 11(3–4), 219–354. doi:10.1561/2200000071

- Mazyavkina, N., Sviridov, S., Ivanov, S., & Burnaev, E. (2020). [Reinforcement Learning for Combinatorial Optimization: A Survey](assets/docs/literature/papers/rl_co.pdf). arXiv [Cs.LG]. Retrieved from http://arxiv.org/abs/2003.03600

- Singh, V. P., Sharma, K., & Chakraborty, D. (2023). [Solving capacitated vehicle routing problem with demands as fuzzy random variable](assets/docs/literature/papers/solving_cvrp_demands_fuzzy_rv.pdf). Soft Comput., 27(21), 16019–16039. doi:10.1007/s00500-023-08888-1

- Li, J., Ma, Y., Gao, R., Cao, Z., Lim, A., Song, W., & Zhang, J. (2022). [Deep Reinforcement Learning for Solving the Heterogeneous Capacitated Vehicle Routing Problem](assets/docs/literature/papers/drl_solving_het_cvrp.pdf). IEEE Transactions on Cybernetics, 52(12), 13572–13585. doi:10.1109/TCYB.2021.3111082

- Golden, B., Levy, L., & Vohra, R. (06 1987). [The orienteering problem](assets/docs/literature/papers/orienteering.pdf). Nav Res Logist, 34, 307–318. doi:10.1002/1520-6750(198706)34:3<307::AID-NAV3220340302>3.0.CO;2-D